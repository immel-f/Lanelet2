...
lanelet2_ml_converter_dir="lanelet2_ml_converter"
...
cp "$lanelet2_ml_converter_dir/README.md" "$dest_dir/lanelet2_ml_converter.md"
cp -r "$lanelet2_ml_converter_dir/doc" "$dest_dir/lanelet2_ml_converter"
